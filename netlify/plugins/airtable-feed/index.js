...
const fetchSubmissions = async () => {
  const response = await fetch(
    `https://api.airtable.com/v0/${AIRTABLE_BASE_ID}/Submissions?maxRecords=500&fields[]=URL&fields[]=screenshot&filterByFormula=TRUE({Approved})&api_key=${AIRTABLE_API_KEY}`,
  );
